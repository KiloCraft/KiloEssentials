...
public class FeatureTypes {
    ...
    public static final FeatureType<ServerWarpManager> WARPS = KiloEssentials.getInstance().registerFeature(FeatureType.create(ServerWarpManager.class, "warps")); // TODO Move to using Provider only.
