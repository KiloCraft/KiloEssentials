...
public class ModData {
    ...
    public ModData() {
        try {
            properties.load(ModData.class.getClassLoader().getResourceAsStream("mod.properties"));
            lang.load(ModData.class.getClassLoader().getResourceAsStream("assets/Lang.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
