...
public class ExtraGameRules {
    ...
    public static final GameRules.Key<GameRules.BooleanRule> BROADCAST_ADMIN_COMMANDS = register("broadcastAdminCommands", GameRules.Category.CHAT, GameRuleFactory.createBooleanRule(false));
