...
public final class PlayerMobDistanceMap {
    ...
    private final Map<PlayerEntity, ChunkPos> players = new HashMap<>();
    ...
    public void update(final List<PlayerEntity> currentPlayers, final int newViewDistance) {
    ...
    private void addPlayerTo(final PlayerEntity player, final int chunkX, final int chunkZ) {
        this.playerMap.compute(ChunkPos.toLong(chunkX, chunkZ), (final Long key, final PooledHashSets.PooledObjectLinkedOpenHashSet<PlayerEntity> players) -> {
            if (players == null) {
                return new PooledHashSets.PooledObjectLinkedOpenHashSet<>();
            } else {
    ...
    private void updatePlayer(final PlayerEntity player, final ChunkPos oldPosition, final ChunkPos newPosition, final int oldViewDistance, final int newViewDistance) {
    ...
    private void removePlayer(final PlayerEntity player, final ChunkPos position, final int viewDistance) {
    ...
    private void addNewPlayer(final PlayerEntity player, final ChunkPos position, final int viewDistance) {
        final int x = position.x;
        final int z = position.z;
