...
public enum CommandPermission {
    ...
    NICKNAME_FORMATTING_EVENT("nickname.formatting.events"),
    NICKNAME_FORMATTING_GRADIENT("nickname.formatting.gradient"),
    NICKNAME_FORMATTING_RAINBOW("nickname.formatting.rainbow"),
    REALNAME("realname"),
    CLEARCHAT("clearchat"),
