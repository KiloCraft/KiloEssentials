...
public class PlayerConnectEventImpl implements PlayerConnectEvent {
    ...
    public PlayerConnectEventImpl(ClientConnection connection, ServerPlayerEntity playerEntity) {
