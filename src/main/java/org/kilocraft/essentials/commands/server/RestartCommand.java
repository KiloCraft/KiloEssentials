...
public class RestartCommand {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        LiteralArgumentBuilder<ServerCommandSource> builder = literal("restart")
                ...
                .requires(s -> Thimble.hasPermissionOrOp(s, KiloCommands.getCommandPermission("server.manage.restart"), 4))
    ...
    private static int execute(ServerCommandSource source, String args) {
        ...
        File marker = new File(FabricLoader.INSTANCE.getGameDirectory(), "RESTARTME");
